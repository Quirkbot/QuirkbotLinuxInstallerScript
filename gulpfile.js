...
var SRC_NAME = 'quirkbot-linux.sh';
var RELEASE_NAME = 'quirkbot-linux-installer';
var PACKAGE = JSON.parse(fs.readFileSync('package.json'));
var VERSION_FILENAME = `${RELEASE_NAME}-${PACKAGE.version}.sh`;
var LATEST_FILENAME = `${RELEASE_NAME}-latest.sh`;
